 ...
 * 
 * 		命名原则：GttEnum.java中的GroupDefaultTest+Rocket共同组成这个单例类：GroupDefaultTestRocket.java
 * 		
 *
 * @author Yangcl
 ...
 * @version 1.0.0.1
 */
public class GroupDefaultTestRocket extends BaseClass {
	
	private BaseMqProducer baseMqProducer = null;
	
	private GroupDefaultTestRocket() {
		baseMqProducer = new BaseMqProducer(GttEnum.GroupDefaultTest);
	} 
	private static class LazyHolder {
		private static final GroupDefaultTestRocket INSTANCE = new GroupDefaultTestRocket();
	}
	public static final GroupDefaultTestRocket getInstance() {
