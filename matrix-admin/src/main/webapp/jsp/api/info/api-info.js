...
var apiInfo = {
        ...
        apiInfo : function(event , treeNode) {  
            ...
            html_ += '<textarea cols="80" rows="5" id="dto-info" name="dtoInfo"  class="longinput "  placeholder="请求Json描述" style="margin-bottom: 10px;width:386px"></textarea><br/>';
            ...
            if(treeNode.name != "新建结点") {
            	html_ = '<button class="stdbtn btn_orange " onclick="apiInfo.openTestDialog(this)" style="margin-left:20px"> 测试 </button>'
        		$("#tree-node-edit").append(html_);
