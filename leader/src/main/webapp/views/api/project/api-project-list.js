    	...
    	index: 'lib/index' //主入口模块
  	    ...
  	    table.render({
  	    	id: 'page-table-reload',  			// 页面查询按钮需要table.reload
  	      	...
  	      	title: 'api所属项目',
  	      	url : layui.setter.path + 'apicenter/ajax_api_project_list.do',
  	      	toolbar: '#table-search-toolbar',
  	      	height: 'full-100', 
 	      	limit: 16,
  	      	cols: [
 	    	  	[
 	  	         	{field:'target', title:'项目名称', width:250,unresize: true, sort: true},  //  fixed: 'left', 
 	  	         	{
 						 field:'atype', 
 						 title:'开放方式', 
 						 width:100, 
