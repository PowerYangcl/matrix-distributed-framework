								...
								<table>
									<tr>
										<td style="border-right:1px solid #ece7e7;width:40%;">
											聊天对象：<select id="to" name="to" style="margin-left:0px; margin-bottom: 10px;">
												<option value="user1">用户：user1</option>
												<option value="user2">用户：user2</option>
												<option value="Yangcl">用户：Yangcl</option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td style="border-right:1px solid #ece7e7;width:40%;" align="right">
											<!-- 
											 ...
											 -->
											<button id="disconnect" class="security-btn layui-btn layui-btn-sm"  key="p2p:disconnect"  lay-submit lay-filter="disconnect">断开链接</button>
											<button id="connect" class="security-btn layui-btn layui-btn-sm"  key="p2p:connect"  lay-submit lay-filter="connect">建立链接</button>
											<button id="send" class="security-btn layui-btn layui-btn-sm"  key="p2p:send"  lay-submit lay-filter="send">发送消息</button>
										</td>
									</tr>
								</table>
							</form>
...
<script type="text/javascript" src="${views}/websocket/p2p/chat.js"></script>
