...
layui.define('jquery', function(exports) {"use strict";
	...
	Element.prototype.tabAdd = function(filter, options) {
		...
		var li = '<li id="' + options.tabId + '" lay-id="' + (options.id || '') + '"' + (options.attr ? ' lay-attr="' + options.attr + '"': '') + '>' + (options.title || 'unnaming') + '</li>';
	...
	Element.prototype.tab = function(options) {
		options = options || {};
		dom.on('click', options.headerElem,
		function(e) {
    ...
    */
	...
	Element.prototype.init = function(type, filter) {
		...
		return items[type] ? items[type]() : layui.each(items,
		function(index, item) {
			item();
		});
	};
