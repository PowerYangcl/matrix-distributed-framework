...
public abstract class RootJob extends BaseClass implements Job, IBaseJob {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		String job = launch.loadDictCache(CachePrefix.SysJob , "SysJobInit").get(jobInfo.getJobName()); 
		...
		if(StringUtils.isNotBlank(jobInfo.getJobList())) {		// 触发其他定时任务
			...
			for(String s : arr) {
				String jobjson = launch.loadDictCache(CachePrefix.SysJob , "SysJobInit").get(s); 
