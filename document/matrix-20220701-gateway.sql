...
CREATE TABLE `mc_role_function` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20280 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `mc_user_info` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20072026234181 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='API表格';
...
CREATE TABLE `mc_user_role` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=522 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
