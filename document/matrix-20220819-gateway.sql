...
(21,'routeId-prod','http://10.226.192.114:8080/bmp-ironic-api/api.do','prod','post','project',1,1,5000000,'2022-08-10 00:00:00','2022-08-30 00:00:00',0,'线上会员接口服务','2022-08-18 14:03:49',2,'Yangcl','2022-08-18 14:03:49',2,'Yangcl',1),
(24,'routeId-pre','http://122.10.20.115:8080/matrix-vip-api/api.do','pre','post','project',1,1,500,'2022-08-10 00:00:00','2022-08-30 00:00:00',1,'预发会员接口服务','2022-08-18 14:12:56',2,'Yangcl','2022-08-18 14:12:56',2,'Yangcl',1);
...
(13,'routeId-pre','Path','matrix/vip/api.do','2022-08-18 14:12:56',2,'Yangcl','2022-08-18 14:12:56',2,'Yangcl',1),
(14,'routeId-pre','After','2022-10-20T17:42:47.789-07:00[America/Denver]','2022-08-18 14:12:56',2,'Yangcl','2022-08-18 14:12:56',2,'Yangcl',1),
...
(7,'routeId-pre','项目访问量统计','1','','','','day','2022-08-18 14:12:56',2,'Yangcl','2022-08-18 14:12:56',2,'Yangcl',1),
(8,'routeId-pre','具体登录人信息统计','4','MANAGER-API-100','userName','admin','day','2022-08-18 14:12:56',2,'Yangcl','2022-08-18 14:12:56',2,'Yangcl',1);
...
CREATE TABLE `mc_organization` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `create_user_id` bigint DEFAULT '0' COMMENT '创建人id',
  `create_user_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '' COMMENT '创建人姓名',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `update_user_id` bigint DEFAULT '0' COMMENT '更新人id',
  `update_user_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT '' COMMENT '更新者姓名',
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
...
(116,0,'leader','133C9CB27E18','administer','administer','','2019-07-16 10:44:25',1992,'Yangcl','2022-08-09 14:28:05',2,'Yangcl',1,NULL),
...
(197,0,'leader','1348B1D284FA','矩阵网关管理员','矩阵网关管理员',NULL,'2022-07-01 16:53:17',2,'Yangcl','2022-07-01 16:56:30',2,'Yangcl',1,NULL);
...
CREATE TABLE `mc_role_function` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20425 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
(20277,197,1127,NULL,'2022-07-01 16:56:30',2,'Yangcl','2022-07-01 16:56:30',2,'Yangcl',1),
(20278,197,1128,NULL,'2022-07-01 16:56:30',2,'Yangcl','2022-07-01 16:56:30',2,'Yangcl',1),
(20279,197,1129,NULL,'2022-07-01 16:56:30',2,'Yangcl','2022-07-01 16:56:30',2,'Yangcl',1),
...
CREATE TABLE `mc_sys_function` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1140 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
(465,1,'Spring-Cloud-Gateway','78',4,2,0,'133C9CB27E18','editor','17f2b7b4b60f455e8fdcbb3a6e37fe4b','','','网关功能配置','','','2018-11-04 13:02:19',2,'Yangcl','2022-08-05 16:32:58',2,'Yangcl',1),
(466,1,'路由规则列表','465',1,3,0,'133C9CB27E18','','','gateway/page_gateway_route_list.do','','路由规则列表','','','2018-11-04 13:06:32',2,'Yangcl','2022-08-08 18:25:39',2,'Yangcl',1),
...
(510,1,'部署节点列表','465',2,3,0,'133C9CB27E18','','','route/page_route_dubbo_node_list.do','','应用服务部署节点列表','','','2019-01-07 14:15:06',2,'Yangcl','2022-08-05 16:39:16',2,'Yangcl',1),
...
(1127,1,'矩阵网关','1',2,0,0,'1348B1D284FA','','','','','matrix-gateway项目权限','','','2022-07-01 16:51:14',2,'Yangcl','2022-07-01 16:51:14',2,'Yangcl',1),
(1128,1,'路由设置','1127',1,1,0,'1348B1D284FA','','','','','项目URL路由规则配置，提供网关路由转发能力，网关路由配置的增加、修改、删除等管理功能','','','2022-07-01 16:54:39',2,'Yangcl','2022-07-01 16:56:15',2,'Yangcl',1),
(1129,1,'服务治理','1127',2,1,0,'1348B1D284FA','','','','','提供降级、熔断、请求处理等网关功能。','','','2022-07-01 16:55:42',2,'Yangcl','2022-07-01 16:55:42',2,'Yangcl',1),
(1130,1,'查 询','466',1,4,0,'133C9CB27E18','','','','忽略查询','真实接口：ajax_gateway_route_list.do','10001','gateway_route_list:search','2022-08-09 11:14:31',2,'Yangcl','2022-08-09 11:25:21',2,'Yangcl',1),
(1131,1,'重 置','466',2,4,0,'133C9CB27E18','','','','忽略查询','真实接口：ajax_gateway_route_list.do','10001','gateway_route_list:reset','2022-08-09 11:15:37',2,'Yangcl','2022-08-09 11:25:15',2,'Yangcl',1),
(1132,1,'添加','466',3,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_add.do','gateway/ajax_btn_gateway_route_add.do','10001','gateway_route_list:add','2022-08-09 11:17:02',2,'Yangcl','2022-08-09 15:49:18',2,'Yangcl',1),
(1133,1,'详情','466',4,5,0,'133C9CB27E18','','','gateway/page_gateway_route_info.do','','详情调整到单独的页面，此处展示断言规则、流量标记关键词等','10003','gateway_route_list:detail','2022-08-09 11:20:08',2,'Yangcl','2022-08-09 11:44:25',2,'Yangcl',1),
(1134,1,'修改','466',5,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_edit.do','gateway/ajax_btn_gateway_route_edit.do','10003','gateway_route_list:edit','2022-08-09 11:23:52',2,'Yangcl','2022-08-09 11:23:52',2,'Yangcl',1),
(1135,1,'生效','466',6,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_resume.do','此条规则是否生效：0-不生效 1-生效','10003','gateway_route_list:resume','2022-08-09 11:31:05',2,'Yangcl','2022-08-09 11:31:05',2,'Yangcl',1),
(1136,1,'暂停','466',7,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_pause.do','此条规则是否生效：0-不生效 1-生效','10003','gateway_route_list:pause','2022-08-09 11:34:29',2,'Yangcl','2022-08-09 11:34:29',2,'Yangcl',1),
(1137,1,'删除','466',8,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_delete.do','软删除','10003','gateway_route_list:delete','2022-08-09 11:35:43',2,'Yangcl','2022-08-09 11:35:43',2,'Yangcl',1);
...
CREATE TABLE `mc_user_info` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20072026234184 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='API表格';
...
(20072026234180,0,0,'gateway','e10adc3949ba59abbe56e057f20f883e','',0,'admin','1348B1D284FA',1,'',1,NULL,'18514037761','794867067@qq.com',NULL,'','default','网关管理员','2022-07-01 16:59:04',2,'Yangcl','2022-07-01 16:59:04',2,'Yangcl',1),
(20072026234181,0,0,'WuYY','e10adc3949ba59abbe56e057f20f883e','',0,'leader','133C9CB27E18',1,'',2,NULL,'18514038888','18514038888@jd.com',NULL,'','default','1234','2022-08-05 18:20:37',2,'Yangcl','2022-08-05 18:20:37',2,'Yangcl',1),
(20072026234182,0,0,'minping','e10adc3949ba59abbe56e057f20f883e','',0,'leader','133C9CB27E18',1,'',1,NULL,'18511112222','minping@jd.com',NULL,'','default','闵平','2022-08-15 12:33:02',2,'Yangcl','2022-08-15 12:33:02',2,'Yangcl',1),
(20072026234183,0,0,'hexinlei','e10adc3949ba59abbe56e057f20f883e','',0,'admin','1348B1D284FA',1,'',1,NULL,'18511111111','18511111111@jd.com',NULL,'','default','何鑫磊','2022-08-18 16:20:02',2,'Yangcl','2022-08-18 16:20:02',2,'Yangcl',1);
...
CREATE TABLE `mc_user_role` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=525 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
(521,20072026234180,197,NULL,'2022-07-01 17:08:07',2,'Yangcl','2022-07-01 17:08:07',2,'Yangcl',1),
(522,20072026234181,116,NULL,'2022-08-05 18:21:04',2,'Yangcl','2022-08-05 18:21:04',2,'Yangcl',1),
(523,2,116,NULL,'2022-08-09 15:12:02',1,'admin','2022-08-09 15:12:02',1,'admin',1),
(524,20072026234182,116,NULL,'2022-08-15 12:33:09',2,'Yangcl','2022-08-15 12:33:09',2,'Yangcl',1);
