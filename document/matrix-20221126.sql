...
(197,0,'leader','1348B1D284FA','matrix-jsp-demo','matrix-jsp-demo',NULL,'2022-07-01 16:53:17',2,'Yangcl','2022-11-18 17:25:23',2,'Yangcl',1,NULL);
...
(251,1,'开发者规约-java','250',1,3,0,'133C9CB27E18','','','example/page_developer_specification.do','','开发者规约','','','2018-07-28 16:42:40',2,'Yangcl','2022-11-18 17:25:39',2,'Yangcl',1),
...
(1127,1,'matrix-jsp-demo','1',2,0,0,'1348B1D284FA','','','','','matrix-jsp-demo项目权限','','','2022-07-01 16:51:14',2,'Yangcl','2022-11-18 15:49:01',2,'Yangcl',1),
...
(1135,1,'生效','466',6,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_enable.do','此条规则是否生效：0-不生效 1-生效','10003','gateway_route_list:enable','2022-08-09 11:31:05',2,'Yangcl','2022-11-17 17:07:42',2,'Yangcl',1),
...
CREATE TABLE `mc_user_info` (
  ...
  `platform` varchar(52) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'P01' COMMENT '平台标识码',
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20072026234185 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='API表格';
...
(20072026234184,'222','e10adc3949ba59abbe56e057f20f883e','admin','1348B1D284FA',1,'',1,NULL,'222','222@ee.com','','','default','222','2022-11-18 18:13:40',2,'Yangcl','2022-11-18 18:13:40',2,'Yangcl',1);
...
(37,4,'棚区经理','技术专家','管理1个有机蔬菜大棚',15000.00,5000.00,2500.00,8,'',1,'兼顾一个棚区的生产管理工作','2022-11-23 15:03:33',1,'admin','2022-11-23 15:03:33',1,'admin',1),
(38,4,'蔬菜培育员(技术专家)','技术专家','管理3个有机蔬菜大棚',12000.00,5000.00,5000.00,6,'入职转正满60个月，且连续3年绩效A以上，考核通过晋升经理',1,'','2022-11-23 15:03:54',1,'admin','2022-11-23 15:03:54',1,'admin',1),
(39,4,'蔬菜培育员(高级培育员)','高级培育员','管理2个有机蔬菜大棚',8000.00,5000.00,3000.00,4,'入职转正满48个月，且连续2年绩效A以上，考核通过进阶技术专家',1,'','2022-11-23 15:04:22',1,'admin','2022-11-23 15:04:22',1,'admin',1),
(40,4,'蔬菜培育员(中级培育员)','中级培育员','管理1个有机蔬菜大棚',6000.00,2500.00,2500.00,3,'入职转正满24个月，且当年绩效A以上，考核通过进阶高级培育员',1,'','2022-11-23 15:04:33',1,'admin','2022-11-23 15:04:33',1,'admin',1),
(41,4,'蔬菜培育员(初级培育员)','初级培育员','管理1个有机蔬菜大棚',5000.00,2500.00,1500.00,3,'入职转正满12个月，且当年绩效B以上，考核通过进阶中级培育员',1,'','2022-11-23 15:04:41',1,'admin','2022-11-23 15:04:41',1,'admin',1),
(42,4,'蔬菜培育员(学员)','学员','协助管理1个有机蔬菜大棚',4000.00,2500.00,1500.00,2,'试用期6个月以后考核通过进阶初级培育员',1,'','2022-11-23 15:04:51',1,'admin','2022-11-23 15:04:51',1,'admin',1),
