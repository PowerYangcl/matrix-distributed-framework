...
(1138,1,'流量标记','466',9,4,0,'133C9CB27E18','','','','ajax_btn_gateway_route_rate_flow.do','显示流量标记关键词','10003','gateway_route_list:rate_flow','2022-08-09 11:39:30',2,'Yangcl','2022-08-09 11:39:30',2,'Yangcl',1),
(1139,1,'流量快照','466',10,5,0,'133C9CB27E18','','','gateway/page_gateway_route_snapshot_list.do','','跳转到流量快照列表页','10003','gateway_route_list:snapshot','2022-08-09 11:41:27',2,'Yangcl','2022-08-09 11:41:27',2,'Yangcl',1);
...
CREATE TABLE `mc_user_info` (
  ...
  `delete_flag` int DEFAULT '1' COMMENT '删除标记: 0删除|1未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=20072026234183 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='API表格';
