...
/**
 * @description: 主从模式适配器；只要求传入一个RedisURI实例，Lettuce会进行拓扑发现机制，自动获取Redis主从节点信息；
 *               不一定需要是主节点的信息，从节点也可以。 【数据读取节点偏好设置】请参考：ReadFrom.java
 * 
 * @author Yangcl
 ...
 * @version 1.0.0.1
 */
public class LettuceMasterReplica extends AbstractLettuceMode {
